...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.purgeUnusedPackagesButton = QtWidgets.QPushButton(self.groupBox)
        ...
        self.checkForUpdatesButton = QtWidgets.QPushButton(self.groupBox)
        ...
        self.removeUnusedPackagesButton = QtWidgets.QPushButton(self.groupBox)
        ...
        self.installUpdatesButton = QtWidgets.QPushButton(self.groupBox)
        ...
        self.openTerminalButton = QtWidgets.QPushButton(self.groupBox_3)
        self.openTerminalButton.setObjectName("openTerminalButton")
        self.verticalLayout.addWidget(self.openTerminalButton)
        self.rebootButton = QtWidgets.QPushButton(self.groupBox_3)
        ...
        self.gridLayout_3.addWidget(self.groupBox_3, 4, 1, 1, 1)
        self.groupBox_2 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_2.setObjectName("groupBox_2")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.groupBox_2)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.removeUserButton = QtWidgets.QPushButton(self.groupBox_2)
        self.removeUserButton.setObjectName("removeUserButton")
        self.gridLayout_2.addWidget(self.removeUserButton, 1, 1, 1, 1)
        self.createUserButton = QtWidgets.QPushButton(self.groupBox_2)
        self.createUserButton.setObjectName("createUserButton")
        self.gridLayout_2.addWidget(self.createUserButton, 0, 1, 1, 1)
        self.changePasswordButton = QtWidgets.QPushButton(self.groupBox_2)
        ...
        self.installSoftwareButton = QtWidgets.QPushButton(self.groupBox_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "Software Updates"))
        ...
        self.groupBox_2.setTitle(_translate("MainWindow", "System Administration"))
        ...
        self.changePasswordButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Changes the password for a user account.</p></body></html>"))
