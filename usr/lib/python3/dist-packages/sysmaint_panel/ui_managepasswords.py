...
class Ui_ManagePasswordsDialog(object):
    def setupUi(self, ManagePasswordsDialog):
        ...
        ManagePasswordsDialog.resize(461, 80)
        ...
        self.diskPassphraseButton = QtWidgets.QPushButton(ManagePasswordsDialog)
        self.diskPassphraseButton.setObjectName("diskPassphraseButton")
        self.gridLayout.addWidget(self.diskPassphraseButton, 1, 2, 1, 1)
    ...
    def retranslateUi(self, ManagePasswordsDialog):
        ...
        self.diskPassphraseButton.setText(_translate("ManagePasswordsDialog", "Disk Passphrase"))
