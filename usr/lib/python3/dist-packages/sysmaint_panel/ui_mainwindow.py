...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bootModeIconLabel = QtWidgets.QLabel(self.centralwidget)
        self.bootModeIconLabel.setText("")
        self.bootModeIconLabel.setObjectName("bootModeIconLabel")
        self.horizontalLayout.addWidget(self.bootModeIconLabel)
        self.bootModeNameLabel = QtWidgets.QLabel(self.centralwidget)
        self.bootModeNameLabel.setObjectName("bootModeNameLabel")
        self.horizontalLayout.addWidget(self.bootModeNameLabel)
        ...
        self.networkConnIconLabel = QtWidgets.QLabel(self.centralwidget)
        self.networkConnIconLabel.setText("")
        self.networkConnIconLabel.setObjectName("networkConnIconLabel")
        self.horizontalLayout_2.addWidget(self.networkConnIconLabel)
        self.networkConnNameLabel = QtWidgets.QLabel(self.centralwidget)
        self.networkConnNameLabel.setObjectName("networkConnNameLabel")
        self.horizontalLayout_2.addWidget(self.networkConnNameLabel)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Data persistence:"))
        self.bootModeNameLabel.setText(_translate("MainWindow", "mode"))
        self.label_3.setText(_translate("MainWindow", "Network connection:"))
        self.networkConnNameLabel.setText(_translate("MainWindow", "state"))
